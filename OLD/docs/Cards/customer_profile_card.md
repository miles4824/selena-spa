# 📌 ĐẶC TẢ SẢN PHẨM & KỸ THUẬT: THẺ HỒ SƠ KHÁCH HÀNG (CUSTOMER PROFILE CARD)
...
- **File JS Xử lý giao diện**: `js/Components/Cards/customer_profile_card.js` & `js/Home/home_dashboard.js`
