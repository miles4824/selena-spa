...
"""
  ...
  <div id="screen-login" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0f111a]/95 backdrop-blur-2xl">
    <div class="w-full max-w-sm glass-card rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/10 text-center relative">
      ...
      <!-- Form Login -->
      <form onsubmit="handlePhoneLogin(event)" class="mt-5 space-y-3.5 text-left">
        <div>
...
"""
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      lucide.createIcons();
      initMenuUI();
      document.getElementById('setting-gas-url').value = localStorage.getItem('selena_gas_url') || '';
    ...
    function handlePhoneLogin(e) {
      ...
      const user = users.find(u => (u.phone === phone || u.user_id === phone) && u.password === pwd);
    ...
    function saveReceiptRecord() {
      ...
      alert('✅ Đã lưu ca gội thành công! Hoa hồng của bạn: +' + comm.toLocaleString('vi-VN') + ' đ');
