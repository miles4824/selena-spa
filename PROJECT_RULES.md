...
- Khách dùng Voucher $ightarrow$ KTV **vẫn được hưởng hoa hồng theo giá gốc niêm yết của Combo**.
...
- Thanh toán 2 pha: Pha 1 (Khách xem QR giấu tip) $ightarrow$ Pha 2 (KTV nhập tip riêng tư).
...
- Khách đi đủ 10 lần trong 60 ngày $ightarrow$ Tự động tặng 1 lần gội miễn phí (100%).
- Quản lý chính xác hạn dùng voucher (30 / 60 / 90 ngày).

---

## 📢 9. THÔNG BÁO NỘI BỘ (ANNOUNCEMENT)
- Chủ tiệm phát thông báo qua `modal_announcement` $ightarrow$ Bắn banner lên đỉnh màn hình KTV trong 0.03s.
