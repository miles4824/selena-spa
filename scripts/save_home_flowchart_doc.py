...
content = """# 🏛️ ĐẶC TẢ KIẾN TRÚC PHÂN LUỒNG HOME DASHBOARD (MODULAR HOME ARCHITECTURE)
...
path = r"c:\Users\Miles\Downloads\Selena\docs\Home\modular_home_flowchart.md"
with open(path, "w", encoding="utf-8") as f:
    f.write(content)
print("Successfully created docs/Home/modular_home_flowchart.md!")
