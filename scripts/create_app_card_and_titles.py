...
# 1. Create js/Core/Components/app_card.js
app_card_code = """// =========================================================================
...
with open('js/Core/Components/app_card.js', 'w', encoding='utf-8') as f:
    f.write(app_card_code.strip() + '\\n')

print("Created app_card.js successfully")
