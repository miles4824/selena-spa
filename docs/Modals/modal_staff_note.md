...
- `2026-09-01` (`v0.0.0.3`): Hoàn thiện kịch bản 2A (trùng số lấy lại tên cũ) và 2B (số mới bật popup xác nhận) cho KTV, đồng thời ghi nhận nhật ký đối soát vào bảng `tb_customer_audits`.
