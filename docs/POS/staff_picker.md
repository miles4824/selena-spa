...
- `2026-09-02` (`v0.0.4.9`):
- `2026-09-02` (`v0.0.5.8`):
- `2026-09-02` (`v0.0.6.0`): Áp dụng chuẩn `text-2xl font-medium font-serif uppercase` cho TẠO TOUR GỘI MỚI và gỡ bỏ icon nút bên phải. Gắn font-mono cho dòng trạng thái nhân sự ('Sẵn sàng phục vụ (3 nhân sự)') hiển thị sắc sảo, cân đối. Xóa bỏ huy hiệu POS thừa, tinh giản tiêu đề Tạo Tour Gội Mới thanh lịch và tự nhiên. Tái thiết kế hoàn toàn UI Header Tạo Tour và huy hiệu trạng thái nhân sự siêu gọn gàng, tinh tế và loại bỏ văn bản dài dòng. Tối ưu dòng trạng thái KTV trên tiêu đề tinh gọn, tự động làm sạch tên hiển thị và chuẩn hóa màu sắc. Cho phép Admin/Chủ tiệm tham gia trực tiếp làm tour (đầy đủ trong KTV 1, KTV Phụ và đếm tổng nhân sự rảnh rỗi).
